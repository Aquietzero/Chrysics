...
var LineTriangle = function(container) {
...
LineTriangle.prototype = {
  ...
  initWorld: function() {
    ...
    var segment = new CHRYSICS.Segment(
      new CHRYSICS.Point(
        ...
        CHRYSICS.Utils.random(-600, -400),
        CHRYSICS.Utils.random(-200,  200)
      ),
      new CHRYSICS.Point(
        CHRYSICS.Utils.random(-200, 200),
        CHRYSICS.Utils.random( 400, 600),
        CHRYSICS.Utils.random(-200, 200)
      )
    );
  ...
  iterate: function() {
    ...
    return function() {
      ...
      var intersect = CHRYSICS.BV.Intersection.lineTriangle(
